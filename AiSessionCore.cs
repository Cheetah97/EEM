...
namespace EEM
{
    ...
    public class AiSessionCore : MySessionComponentBase
    {
        ...
        public delegate void DamageHandlerDelegate(IMySlimBlock Block, MyDamageInformation Damage);
        private static readonly Dictionary<long, DamageHandlerDelegate> DamageHandlers = new Dictionary<long, DamageHandlerDelegate>();

        private static void AddDamageHandler(long gridId, DamageHandlerDelegate handler)
        {
            DamageHandlers.Add(gridId, handler);
        }

        public static void AddDamageHandler(IMyCubeGrid grid, DamageHandlerDelegate handler)
        {
